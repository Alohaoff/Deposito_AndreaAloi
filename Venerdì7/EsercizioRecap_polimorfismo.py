...
print(teatro.prenota_posto(1, "A"))  
print(teatro.prenota_posto(10, "Z")) 
# Problema crea comunque la prenotazione nonostante il posto non sia disponibile
teatro.stampa_posti_occupati()# lista posti occupati
